...
class DEXTR_HANDLER:
    ...
    def handle(self, db_data, frame, points):
        ...
        pred = self._exec_network.infer(inputs={self._input_blob: input_dextr[np.newaxis, ...]})[self._output_blob][0,
               0, :, :]
        ...
        bounding_box[0]:bounding_box[0] + pred.shape[1]] = pred > _DEXTR_TRESHOLD
