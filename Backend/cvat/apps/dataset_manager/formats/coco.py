...
from cvat.apps.dataset_manager.bindings import CvatTaskDataExtractor, import_dm_annotations
...
def _export(dst_file, task_data, save_images=False):
    ...
    with TemporaryDirectory() as temp_dir:
        converter = dm_env.make_converter('coco_instances', save_images=save_images)
